...
# This code is called by potentialFinder-2019-scientificplots.ipynb and is used to do exponential and logistic fit
# It also saves graphs of the fit at the designated location
#############
...
def find_exponents(df,
	...
	exp_b,exp_a,exp_r_s = None, None, None
	...
	for datetimecol in data.columns: 
		...
		if 'date_days_since_first_date' in df_temp:
